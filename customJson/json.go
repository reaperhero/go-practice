...
func (j *Json) MustArray(args ...[]interface{}) []interface{} {
	...
	case 1:
		def = args[0]
	default:
		fmt.Printf("MustArray() received too many arguments %d", len(args))
		return nil
	}
...
func (j *Json) MustMap(args ...map[string]interface{}) map[string]interface{} {
	...
	case 1:
		def = args[0]
	default:
		fmt.Printf("MustMap() received too many arguments %d", len(args))
	}
...
func (j *Json) MustString(args ...string) string {
	...
	case 1:
		def = args[0]
	default:
		fmt.Printf("MustString() received too many arguments %d", len(args))
	}
...
func (j *Json) MustStringArray(args ...[]string) []string {
	...
	case 1:
		def = args[0]
	default:
		fmt.Printf("MustStringArray() received too many arguments %d", len(args))
	}
...
func (j *Json) MustInt(args ...int) int {
	...
	case 1:
		def = args[0]
	default:
		fmt.Printf("MustInt() received too many arguments %d", len(args))
	}
...
func (j *Json) MustFloat64(args ...float64) float64 {
	...
	case 1:
		def = args[0]
	default:
		fmt.Printf("MustFloat64() received too many arguments %d", len(args))
	}
...
func (j *Json) MustBool(args ...bool) bool {
	...
	case 1:
		def = args[0]
	default:
		fmt.Printf("MustBool() received too many arguments %d", len(args))
	}
...
func (j *Json) MustInt64(args ...int64) int64 {
	...
	case 1:
		def = args[0]
	default:
		fmt.Printf("MustInt64() received too many arguments %d", len(args))
	}
...
func (j *Json) MustUint64(args ...uint64) uint64 {
	...
	case 1:
		def = args[0]
	default:
		fmt.Printf("MustUint64() received too many arguments %d", len(args))
	}
