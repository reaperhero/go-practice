...
Install:
	...
	go get github.com/reaperhero/beego/v2/core/validation

Test:

	go test github.com/reaperhero/beego/v2/core/validation
...
Direct Use:
	...
	import (
		"github.com/reaperhero/beego/v2/core/validation"
		"log"
	)
